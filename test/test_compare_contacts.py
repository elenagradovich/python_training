...
def test_compare_data_of_contacts_by_index(app):
    ...
    assert contact_from_home_page_by_index.id == clear(contact_from_edit_page_by_index.id)
    assert contact_from_home_page_by_index.lastname == clear(contact_from_edit_page_by_index.lastname)
    assert contact_from_home_page_by_index.firstname == clear(contact_from_edit_page_by_index.firstname)
